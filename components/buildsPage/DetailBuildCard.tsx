  ...
  const DROPDOWN_INNER = (
    <DropdownItem>
      <div className="col text-nowrap overflow-hidden text-overflow-ellipsis">
        <Icon icon="Send" /> <span onClick={() => setConnectAsModal(true)}> Connect as </span>
      </div>
    </DropdownItem>
  );
        ...
        <CardBody>
          <div className="d-flex justify-content-between">
            <div style={{ display: 'flex' }}>
              <Icon icon={'PersonAdd'} color="primary" size="lg" forceFamily={null} />
              <h5 style={{ marginLeft: '10px' }}>{'C2D'}</h5>
            </div>
            <div>
