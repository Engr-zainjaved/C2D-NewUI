    ...
    onSubmit: (values) => {
      ...
      if (values.repoSelection === 'new') {
        payload = {
          ...
          odoo_version: values.odooVersion,
        ...
        <Card shadow="md" borderColor={null} stretch={true} hasTab={false}>
          <CardBody tag="CreateProject">
            <form onSubmit={formik.handleSubmit}>
              <div className="col-12 d-flex justify-content-center " style={{ fontSize: 'calc(3rem + 3vw)' }}>
                <h1>Deploy Your Platform </h1>
              </div>
              <Alert isLight color="success">
                <div className="col-12 d-flex align-items-center justify-content-center">
                  Each odoo.sh project is linked to a GitHub repository where your modules will be stored. Please create
                  or select the repository for this project linked to your GitHub account.
                </div>
              </Alert>
                    ...
                    <div className="card">
                      <div className="card-body">
                        <Select
                          ...
                          value={formik.values.odooVersion as unknown as string}
                          onChange={(event: any) => {
                            const selectedValue = event.target.value;
