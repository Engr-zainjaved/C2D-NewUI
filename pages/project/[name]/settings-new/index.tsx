        ...
        <div className="row mt-5">
          <div className="col-12 col-md-4">
            <div className="d-flex flex-column gap-3 setting-info">
              ...
              <p>
                All installed modules will be tested except if you select Full installation. This setting applies only
                to this development branch.
              </p>
            </div>
          </div>
          <div className="col-12 col-md-8">
        ...
        <div className="row mt-5">
          <div className="col-12 col-md-4">
            <div className="d-flex flex-column gap-3 setting-info">
              ...
              <p>
                Odoo has a test suite that can help validate your customizations. You can choose to disable it if you
                wish to reduce the build's creation time, but be aware this goes against best practices.
              </p>
            </div>
          </div>
          <div className="col-12 col-md-8">
        ...
        {true && showAlert && (
          <Alert color="danger" isLight className="d-block p-3">
            <div>
              ...
              <InputGroup className="c2d-input-group">
                <Input placeholder="type the name 'branchName' to confirm" />
